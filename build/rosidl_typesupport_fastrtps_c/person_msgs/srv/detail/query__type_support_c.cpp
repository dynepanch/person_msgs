...
// already included above
// #include "rosidl_runtime_c/string.h"  // tips
// already included above
// #include "rosidl_runtime_c/string_functions.h"  // tips
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: tips
  {
    const rosidl_runtime_c__String * str = &ros_message->tips;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: tips
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->tips.data) {
      rosidl_runtime_c__String__init(&ros_message->tips);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->tips,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'tips'\n");
      return false;
    }
  }
